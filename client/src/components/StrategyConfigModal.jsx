...
export function StrategyConfigModal({ isOpen, onClose, config, strategyName }) {
    ...
    const modalContent = (
        ...
        >
            <div className="bg-white w-[95%] max-w-5xl max-h-[90vh] flex flex-col rounded-[2rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.3)] border border-slate-200 overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-8 duration-500 fill-mode-forwards ease-out">
                {/* Compact Header */}
                <div className="px-8 py-5 border-b border-slate-100 flex items-center justify-between bg-white shrink-0">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-slate-900 tracking-tight leading-none">Strategy Configuration</h3>
                            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1.5 opacity-70">
                ...
                <div className="flex-1 overflow-y-auto w-full custom-scrollbar bg-slate-50/50">
                    <div className="p-8 pb-12 w-full max-w-6xl mx-auto h-full"> 
                        <StrategyFormContent 
                            config={config} 
                            setConfig={() => {}} 
                            isReadOnly={true} 
