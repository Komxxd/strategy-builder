...
export function StrategyLogs({ isOpen, onClose, logs, strategyName }) {
 ...
 >
 <div className="bg-white w-full max-w-xl h-[550px] flex flex-col rounded-xl )] border border-slate-200 overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-8 duration-500 fill-mode-forwards ease-out">
 {/* Compact Header */}
 ...
 return (
 <div key={i} className="group flex items-start gap-2.5 py-1 px-2.5 rounded hover:bg-white hover: border border-transparent hover:border-slate-100 transition-all duration-200">
 {/* Time Column */}
