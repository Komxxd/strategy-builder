...
'Exit Reason': t.exit_reason ||'-'
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 bg-white hover:bg-slate-50 text-slate-700 text-[11px] font-bold border border-slate-200 rounded-md transition-colors"
 >
